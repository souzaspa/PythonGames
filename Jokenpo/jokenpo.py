...
# ---------------------------------------------------------------------------------
# Layouts
pedra.grid(row=0, column=0, columnspan=2, pady=5)
papel.grid(row=1, column=0, columnspan=2, pady=5)
tesoura.grid(row=2, column=0, columnspan=2, pady=5)
btn_regras.grid(row=3, column=1, pady=10, padx=(30, 0))
btn_resultado.grid(row=3, column=0, pady=10, padx=(30, 0))
vitoria_res.grid(row=4, column=0, pady=10, padx=10)
vitoria_lb.grid(row=4, column=1, pady=10)
empate_res.grid(row=5, column=0, pady=10)
empate_lb.grid(row=5, column=1, pady=10)
derrota_res.grid(row=6, column=0, pady=10)
derrota_lb.grid(row=6, column=1, pady=10)
