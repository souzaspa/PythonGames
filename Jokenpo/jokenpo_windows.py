...
def jogada():
    ...
    # Resultado
    resultado = Label(resultado, text=final, font='Arial 10 bold')
...
pedra = Radiobutton(root, text='Pedra', font='Arial 10', variable=jog, value='1')
papel = Radiobutton(root, text='Papel', font='Arial 10', variable=jog, value='2')
tesoura = Radiobutton(root, text='Tesoura', font='Arial 10', variable=jog, value='3')
btn_resultado = Button(root, text='Jogar', font='Arial 10', command=jogada)
btn_regras = Button(root, text='Regras', font='Arial 10', command=regras)
vitoria_res = Label(root, text='Vitórias: ', font='Arial 10 bold', fg='green')
vitoria_lb = Label(root, text=vitoria, font='Arial 10 bold', fg='green')
empate_res = Label(root, text='Empates: ', font='Arial 10 bold', fg='blue')
empate_lb = Label(root, text=empate, font='Arial 10 bold', fg='blue')
derrota_res = Label(root, text='Derrotas: ', font='Arial 10 bold', fg='red')
derrota_lb = Label(root, text=derrota, font='Arial 10 bold', fg='red')
